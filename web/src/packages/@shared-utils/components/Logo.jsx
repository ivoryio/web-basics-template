...
const Logo = ({ color, height, variant, width, ...props }) => {
  switch (variant) {
    case 'short':
      return <LogoShort color={color} height={height} width={width} {...props} />
    case 'full':
      return <LogoFullDefault color={color} height={height} width={width} {...props} />
    case 'full_material':
      return <LogoFullMaterial height={height} width={width} {...props} />
    default:
      console.error(`* Invalid logo size provided. Expected one of ${logoVariants}.`)
      return null
  }
}
...
const LogoShort = ({ color, height, width, ...props }) => (
  <Icon
    ...
    {...props}
  >
    <path className="starterkit-logo-short-light" d="M12.9204 8.73614Z" fill={color} />
  </Icon>
)
...
const LogoFullMaterial = ({ height, width, ...props }) => (
  <Icon {...props} fill="none" height={height} viewBox="0 0 94 44" width={width} xmlns="http://www.w3.org/2000/svg">
    <g>
      <path
